...
| ST-21 | S-04 | `saved` (current controls after app update, visible Critic Claude Code Opus 5.5 with Medium/High/Extra/Max, current encrypted instruction revision and saved-version metadata) | `#settings` · UC-005 |
...
S-02/ST-09 supports concise individual assignments and out-of-order worker completion in canonical commit order. Reuse current message recipient labels for Critic orders, corrections and assessments; internal role guidance and IDs are not transcript messages. Existing status text distinguishes actual working, waiting for a dependency or provider queue, and completed work without a new dashboard. ST-16 preserves partial successful work and exposes Retry; ST-11 cancels all active workers. S-04/ST-21–ST-24 describes fixed 1/3/5 team-review counts and Auto separately. S-07/ST-37–ST-38 distinguishes resolved advice from advice carrying unresolved or evidence-blocked orders. These are variants of existing states, not new routes or a new visual composition.
