...
22 September 2026 · Codex design executor · Electric A v8 remains approved; current Settings vocabulary revalidated below
...
|---|---|---|---|
| MAT-01 | `docs/prd.md` · SHA-256 `b0701e21c58e1a025027b41f0d70b50a04a57c427ee108f9369dd5cd5ae9214e` | true | Current specification; resolved filesystem read |
| MAT-02 | `docs/project-context.md` · SHA-256 `9ba88481e64d383769ee82165a85d93f4042b6861946da37669a7c38830f414c` | true | Current specification; resolved filesystem read |
| MAT-03 | `docs/canonical-terms.md` · SHA-256 `39f0bab599c0a0d8128f1566b65f04b6f78e30a689b41bbeee0e2b651deeed47` | true | Current specification; resolved filesystem read |
| MAT-04 | `docs/guardrails.md` · SHA-256 `9353ac9779aeb8bcbc583fb4cd8fb5b3f30ca39ea881b53842b2fcd172a172eb` | true | Current specification; resolved filesystem read |
| MAT-05 | `docs/user-journey.md` · SHA-256 `5903371a5d1b767c7782e6199d12ce0659dff13bd2a920ded24008509c9b6f14` | true | Current specification; resolved filesystem read |
| MAT-06 | `docs/screen-map.md` · SHA-256 `40df920688609526f1b3d5a4082a341e15c0932e12192b75a4cf87409eb7b343` | true | Current specification; resolved filesystem read |
| MAT-07 | `docs/wireframes.md` · SHA-256 `4f7378790527ef8c9e52de1fa799fd6f14bb343b484b15d06b719d4caaf1d976` | true | Current specification; resolved filesystem read |
| MAT-08 | `docs/product-idea.md` · SHA-256 `aa7c43bfebc390d128b79d16e52054c5bfebb1c51d4b5697911b179542d56d14` | true | Current specification; resolved filesystem read |
...
| MAT-56 | Owner-supplied Claude picker screenshot, 22 September 2026 | true | Claude picker evidence for Opus 5.5 and Medium (Default); the owner's later explicit correction excludes Low from NanoDuck's Opus 5.5 Critic selector; screenshot inspected and deliberately not copied into the public repository |
...
| Settings controls | Independent model/reasoning controls, a visible Critic Claude Code provider branch, a native message-sound select with owner-activated Preview, and a visible full-height editable runtime-instructions Markdown document from encrypted database storage, with current revision/status and a compact saved-version list. The Critic selection displays Claude Code, Opus 5.5 and Medium (Default), and offers Medium, High, Extra and Max; Low is excluded. Sound options are Knock, Chime, Ripple and Off; visual feedback remains when sound is off or blocked. Review opens a read-only dialog; Restore is explicit and creates a new current revision. Each save or restore affects only the next run; malformed required headings/placeholders or a stale revision show a specific local error. |
...
The 25 September parallel-consultation contract changes the semantics of discussion content within the existing Electric A v8 surface. Preserve all baseline geometry, control placement, role styling and frozen candidate bytes. Head assignments, out-of-order independent results, Critic orders, corrections and assessments use the existing chronological role/recipient message shape. Private role guidance, dependency graphs and resolution IDs remain hidden. Long verbatim tasks and complete final answers must wrap and remain readable; the interface gains no orchestration dashboard.
