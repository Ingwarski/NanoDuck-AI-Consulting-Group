...
|---|---|---|---|
| MAT-01 | `docs/prd.md` · SHA-256 `d1762dc72052150e15dafbe0c0f7bcb2f0e1bb1b63f4c630cfa39c26e5b00a9d` | true | Current specification; resolved filesystem read |
| MAT-02 | `docs/project-context.md` · SHA-256 `996e72fb0acf85e8b67b1730e7625779ff584bc8e9292d6bfc46b6bcc05276f2` | true | Current specification; resolved filesystem read |
| MAT-03 | `docs/canonical-terms.md` · SHA-256 `a0d29a01201747247cf721bc5ae149c08b1938dcff2b5aef04053cc3c5217446` | true | Current specification; resolved filesystem read |
...
| MAT-05 | `docs/user-journey.md` · SHA-256 `5b65d7e380cad36b15872a39640318389c11d744bde036bde6d2760f214aff2a` | true | Current specification; resolved filesystem read |
| MAT-06 | `docs/screen-map.md` · SHA-256 `cb1597ed54b3140b8eecf385cae8d58179fa1e3bcc54bdd5fe8d1e1dc68d6ba2` | true | Current specification; resolved filesystem read |
| MAT-07 | `docs/wireframes.md` · SHA-256 `e6ff54b0d3827dc74dbfdd6c0794ed5b79922ed0de506be978301d9e20cd4c53` | true | Current specification; resolved filesystem read |
| MAT-08 | `docs/product-idea.md` · SHA-256 `c3c72ff583ed11f6a2b99bc6b9f9b7a3340617e7176f6fc6534abdc11827d0dd` | true | Current specification; resolved filesystem read |
...
| MAT-56 | Owner-supplied Claude picker screenshot, 22 September 2026 | true | Current user-facing model and effort vocabulary: Opus 5.5 and Medium (Default); inspected in this task and deliberately not copied into the public repository |
...
| Settings controls | Independent model/reasoning controls, optional Critic provider, a native message-sound select with owner-activated Preview, and a visible full-height editable runtime-instructions Markdown document from encrypted database storage, with current revision/status and a compact saved-version list. The current Critic selection displays Claude Code, Opus 5.5 and Medium (Default). Sound options are Knock, Chime, Ripple and Off; visual feedback remains when sound is off or blocked. Review opens a read-only dialog; Restore is explicit and creates a new current revision. Each save or restore affects only the next run; malformed required headings/placeholders or a stale revision show a specific local error. |
