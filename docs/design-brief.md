...
The owner’s 23 September consultation correction changes only the Settings depth wording to a Head-directed ceiling and the semantics of discussion content. Preserve all Electric A v8 geometry, control placement, role styling and frozen candidate bytes. Long verbatim tasks and complete final answers must wrap and remain readable in the existing message layout; the interface gains no orchestration screen.
